    ...
    <head>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
            <meta name="viewport" content="width=device-width,initial-scale=1.0">
                ...
                $this->helix3->addCSS('bootstrap.min.css, font-awesome.min.css, default.css, j2store.css') // CSS Files
                        ->addJS('bootstrap.min.js, jquery.sticky.js, main.js, wow.min.js, scroll.js, custom.js, jquery.easing.min.js') // JS Files
