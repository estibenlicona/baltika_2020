...
class venue_listJSModel extends JSPRO_Models
{
	...
	function _buildContentOrderBy()
	{
		...
		$this->_lists["sortfield"]	= $mainframe->getUserStateFromRequest( 'com_joomsport.venue_list_field', 'sortfield', 'v_name', 'string' );
		$this->_lists["sortway"]	= $mainframe->getUserStateFromRequest( 'com_joomsport.venue_list_way', 'sortway', 'ASC', 'string' );
