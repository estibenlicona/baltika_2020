...
class seasonteam_menuJSModel extends JSPRO_Models
{
	...
	function _buildQuery()
	{
		...
		$query = "SELECT s.s_id as id, CONCAT(t.name,' ',s.s_name) as name FROM #__bl_tournament as t, #__bl_seasons as s WHERE s.published = '1' AND t.published = '1' AND t.t_single = '0' AND s.t_id = t.id  ORDER BY t.name, s.s_name";
