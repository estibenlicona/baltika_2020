...
class JFormFieldVenue extends JFormField
{
	/**
	 * Element name
	 *
	...
	protected function getInput()
	{
		...
		$article->title = '';
		if ($this->value) {
			$query = "SELECT * FROM #__bl_venue WHERE id=".$this->value;
			$db->setQuery($query);
		...
		$link = 'index.php?option=com_joomsport&amp;task=venue_menu&amp;tmpl=component';
