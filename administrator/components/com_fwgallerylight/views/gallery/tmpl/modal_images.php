...
?>
<form action="index.php?option=com_fwgallerylight&amp;view=gallery&amp;layout=modal&amp;sublayout=images&amp;tmpl=component&amp;function=<?php echo $this->function; ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
    <div class="row-fluid">
                ...
                <td>
                    <div class="row center">
                        <a href="javascript:" onclick="if (window.parent) window.parent.<?php echo $this->escape($this->function); ?>('<?php echo $file->id; ?>');">
                            <img src="<?php echo JURI::root(true); ?>/index.php?option=com_fwgallerylight&amp;view=image&amp;layout=image&amp;format=raw&amp;id=<?php echo $file->id; ?>&amp;w=80&amp;h=60" alt="" />
                        </a>
                    </div>
                </td>
