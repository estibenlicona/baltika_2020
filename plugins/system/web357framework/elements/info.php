...
class JFormFieldinfo extends JFormField {
	...
	{	
		...
		$changelog_url = 'https://www.web357.com/joomla-extensions/'.$real_ext_name_with_dashes.'#changelog';  // e.g. support-hours
		...
		if (!empty($latest_version) && !empty($latest_creationDate))
		{
			...
			else
			{
				...
				&nbsp;&nbsp;&nbsp;'.JText::_('W357FRM_OR').'&nbsp;&nbsp;&nbsp;
				<a href="https://www.web357.com/downloads/" target="_blank">'.JText::_('W357FRM_GO_TO_DOWNLOAD_AREA').'</a>
				</div>';
			}
		}
		else
