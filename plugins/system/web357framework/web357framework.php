		...
		public function onAfterInitialise()
		{
			...
			if ($app->isAdmin())
			{
				...
				))
				{
					...
					// js
					JFactory::getDocument()->addScript(JURI::root(true).'/media/plg_system_web357framework/js/script.min.js?v=1.7.6_20190423112938');

					// css
					JFactory::getDocument()->addStyleSheet(JURI::root(true).'/media/plg_system_web357framework/css/style.min.css?v=1.7.6_20190423112938');
				}
			}
		}
