...
<div class="container-popup">
	...
	<form action="<?php echo JFHelper::checkLink(JRoute::_('index.php?option=com_fwgallerylight&view=gallery&layout=modal&tmpl=component&function=' . $this->function . '&' . JSession::getFormToken() . '=1')); ?>" method="post" name="adminForm" id="adminForm" class="form-inline form-validate">
        ...
        <a class="btn" href="<?php echo JFHelper::checkLink(JRoute::_('index.php?option=com_fwgallerylight&view=gallery&layout=modal&tmpl=component&project_id='.$input->getInt('project_id').'&function=' . $this->function . '&' . JSession::getFormToken() . '=1')); ?>"><?php echo JText :: _('FWG_CANCEL'); ?></a>
