...
?>
<form action="<?php echo JFHelper::checkLink(JRoute::_('index.php?option=com_fwgallerylight&view=gallery&layout=modal&sublayout=galleries&tmpl=component&function='.$this->function)); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
    <div class="row-fluid">
        <div class="btn-toolbar">
            ...
            <div class="btn-group pull-right hidden-phone">
                <a class="btn btn-primary" href="<?php echo JFHelper::checkLink(JRoute :: _('index.php?option=com_fwgallerylight&view=gallery&layout=modal_add&tmpl=component&function=' . $this->function)); ?>"><?php echo JText :: _('FWG_ADD_NEW_GALLERY'); ?></a>
            </div>
        </div>
    </div>
