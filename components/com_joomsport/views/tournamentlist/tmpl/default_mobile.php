...
<div class="page-content">
    ...
    <!-- /.navbar -->
    <form action="<?php echo JRoute::_("index.php?option=com_joomsport&view=tournamentlist&Itemid=" . $Itemid . "&page=1"); ?>" method="post" name="adminForm" id="adminForm">      
        <div class="main teamList">
            ...
            <div class="table-responsive col-xs-12 col-lg-12">
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <th><h3><?php echo JText::_('BLFA_TOURNAMENT'); ?></h3></th>
                    </tr>
                    </thead>
                    <tbody>
                        <?php
                        for ($i = 0; $i < count($this->row); $i++) {
                            ...
                            <tr class="<?php echo $i % 2 ? "" : "active"; ?>">
                                <td class="left"><a href="<?php echo $link ?>"><?php echo $tourn->name ?></a></td>
