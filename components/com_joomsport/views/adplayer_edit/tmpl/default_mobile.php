...
<div class="page-content">
    ...
    <div class="main editTeam">
        <div class="heading col-xs-12 col-lg-12">
            <h1 class="pull-left col-xs-12 col-sm-12 col-md-4 col-lg-4"><?php echo $row->id ? JText::_('BLFA_PLAYER_EDIT') : JText::_('BLFA_PLAYER_NEW'); ?></h1>
        ...
        <div class="tools col-xs-12 col-lg-12 text-right"> 
            <?php if ($this->acl == 1) { ?>
                ...
                return false;"><i class="save"></i> <?php echo JText::_('BLFA_SAVE') ?></a>
                   <?php } ?>
                <a href="<?php echo JRoute::_("index.php?option=com_joomsport&controller=admin&view=admin_player&sid=" . $lists["s_id"] . "&Itemid=" . $Itemid); ?>" title="<?php echo JText::_('BLFA_CLOSE') ?>"><i class="delete"></i> <?php echo JText::_('BLFA_CLOSE') ?></a>
            <?php } else { ?>
        ...
        function submitbutton(pressbutton) {
            ...
            <form action="<?php echo $formlink; ?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data" class="form-horizontal form-validate" >
                <div class="">

                    <div class="form-group">
                        <label class="col-sm-2 control-label"><?php echo JText::_('User'); ?>: <i class="fa fa-question-circle"></i></label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><?php echo JText::_('BLFA_FIRSTNAME'); ?>: <i class="fa fa-question-circle"></i></label>
                        <div class="col-sm-4">
                            <input type="text" maxlength="255" class="form-control required" id="first_name" name="first_name" value="<?php echo htmlspecialchars($row->first_name) ?>" />                                
                        </div>
                    </div>
                    <?php if ($lists['reg_lastname']) { ?>	
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><?php echo JText::_('BLFA_LASTNAME'); ?>: <i class="fa fa-question-circle"></i></label>
                            <div class="col-sm-4">
                                <input type="text" maxlength="255" class="form-control <?php echo ($this->lists['reg_lastname_rq'] == 1 ) ? (" required") : ("") ?>" id="last_name" name="last_name" value="<?php echo htmlspecialchars($row->last_name); ?>" />                                
                            </div>
                        </div>
                    ...
                    if ($lists['nick_reg']) {
                        ?>
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><?php echo JText::_('BL_NICK'); ?>: <i class="fa fa-question-circle"></i></label>
                            <div class="col-sm-4">
                                <input type="text" maxlength="255" class="form-control <?php echo ($this->lists['nick_reg_rq'] ) ? " required" : ""; ?>" id="nick" name="nick" value="<?php echo htmlspecialchars($row->nick) ?>" />                                
                            </div>
                        </div>
                        <?php
                    }
                    if ($lists['country_reg']) {
                        ?>
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><?php echo JText::_('BL_COUNTRY'); ?>: <i class="fa fa-question-circle"></i></label>
                            <div class="col-sm-4">
                    ...
                    <?php if (isset($lists['teams_seas'])): ?>
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><?php echo JText::_('BLFA_TEAM'); ?>: <i class="fa fa-question-circle"></i></label>
                            <div class="col-sm-4">
                    ...
                    ?>
                    <div class="form-group">
                        <label for="about" class="col-sm-2 control-label"><?php echo JText::_('BLFA_ABOUT_PLAYER'); ?>: <i class="fa fa-question-circle"></i></label>
                        <div class="col-sm-6">
                            <textarea class="form-control" name="about" id="about" rows="6"><?php echo htmlspecialchars($row->about, ENT_QUOTES); ?></textarea>
                        </div>
                    </div>
