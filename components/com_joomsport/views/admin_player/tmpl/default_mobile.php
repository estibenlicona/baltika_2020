...
<div class="page-content">
    ...
    <div class="main adminPlayer">
        <div class="heading col-xs-12 col-lg-12">
            ...
            <?php if ($this->acl == 2) { ?>
                <h1 class="pull-left col-xs-12 col-sm-12 col-md-4 col-lg-4"><?php echo JText::_('BLFA_PLAYERSLIST') ?></h1>
        ...
        <div class="navbar-link col-xs-12 col-lg-12">
            <ul>
                <?php if ($this->acl == 2) { ?>
                    <li><a href="<?php echo JRoute::_('index.php?option=com_joomsport&controller=moder&view=edit_team&tid=' . $this->tid . '&Itemid=' . $Itemid); ?>" title=""><?php echo JText::_('BLFA_TEAM') ?></a></li>
