...
<!--
    ...
    function submitbutton(pressbutton) {
        ...
        if ('<?php echo $this->acl; ?>' == 1 && '<?php echo $lists['t_type'] ?>' == 0 && document.adminForm.m_id.value == 0) {
            alert("<?php echo JText::_('BLFA_PLSELMD'); ?>");
            return false;
        }
    ...
    function bl_add_event() {
        ...
        if (cur_event.value == 0) {
            alert("<?php echo JText::_('BLFA_JSMDNOT4'); ?>");
            return;
        }
        if (e_player.value == 0) {
        ...
        cell1.innerHTML = '<button type="button" class="close" onclick="Delete_tbl_row(this); return false;"><span aria-hidden="true">&times;</span><span class="sr-only"><?php echo JText::_('BLFA_DELETE'); ?></span></button>';
...
<div class="page-content">
    ...
    <div class="main editMatch">
        <div class="heading col-xs-12 col-lg-12">
            <h1 class="pull-left col-xs-12 col-sm-12 col-md-4 col-lg-4"><?php echo JText::_("BLFA_MATCH_EDIT"); ?></h1>
        ...
        return false;"><i class="apply"></i> <?php echo JText::_('BLFA_APPLY') ?></a>
               <?php if ($this->acl == 1) { ?>
                <a href="<?php echo JRoute::_('index.php?option=com_joomsport&view=edit_matchday&controller=admin&sid=' . $s_id . '&cid[]=' . $row->m_id . '&Itemid=' . $Itemid); ?>" title="<?php echo JText::_('BLFA_CLOSE') ?>"><i class="delete"></i> <?php echo JText::_('BLFA_CLOSE') ?></a>
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="#main" role="tab" data-toggle="tab"><i class="star"></i></i><?php echo JText::_('BLFA_MAIN') ?></a></li>
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="main">                
                    <div class="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                if ($lists['t_type'] == 1 || ($this->acl != 1 && (($this->lists["jsmr_editresult_opposite"] == 0 && !$moder_or_pl) || ($this->lists["jsmr_editresult_yours"] == 0 && $moder_or_pl)))) {
                                    echo '<label class="">' . $lists['teams1'] . '</label> <input type="hidden" name="score1" value="' . $row->score1 . '" size="5" maxlength="5"  />' . $row->score1;
                                } else {
                                    echo '<label class="">' . $lists['teams1'] . ' <input class="form-control score" type="text" name="score1" value="' . $row->score1 . '" size="5" maxlength="5" onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);" onkeypress="return blockNonNumbers(this, event, false, false);" />';
                                }
                                if ($lists['s_enbl_extra'] && $lists['t_type']) {
                                    echo '&nbsp;' . JText::_("AET") . '<input class="form-control score" type="text" id="aet1" name="aet1" value="' . $row->aet1 . '" size="5" maxlength="5" ' . ($row->is_extra ? "" : "disabled") . ' onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);" onkeypress="return blockNonNumbers(this, event, false, false);" />&nbsp;';
                                }
                                if ($lists['t_type']) {
                                    echo JText::_("W") . '<input class="form-control score" type="checkbox" id="spenwin_1" ' . (( $row->p_winner && $row->p_winner == $row->team1_id) ? "checked" : "") . ' name="penwin[]" value="' . $row->team1_id . '" onchange="sqchng(\'spenwin_1\',\'spenwin_2\');" onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);" onkeypress="return blockNonNumbers(this, event, false, false);" />';
                                }
                                if ($lists['t_type'] == 1 || ($this->acl != 1 && (($this->lists["jsmr_editresult_opposite"] == 0 && !$moder_or_pl2) || ($this->lists["jsmr_editresult_yours"] == 0 && $moder_or_pl2)))) {
                                    echo '&nbsp;<span>:</span>&nbsp;<label class="">' . $lists['teams2'] . '</label> <input type="hidden" name="score2" value="' . $row->score2 . '" size="5" maxlength="5"  />' . $row->score2;
                                } else {
                                    echo '&nbsp;<span>:</span>&nbsp;<label class="">' . $lists['teams2'] . '</label>&nbsp;<input  class="form-control score" type="text" name="score2" value="' . $row->score2 . '" size="5" maxlength="5" onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);" onkeypress="return blockNonNumbers(this, event, false, false);" />';
                                }
                                //'.($lists['s_enbl_extra']?"":"disabled").'

                                if ($lists['s_enbl_extra'] && $lists['t_type']) {
                                    echo '&nbsp' . JText::_("AET") . '<input class="form-control score" type="text" id="aet2" name="aet2" value="' . $row->aet2 . '" size="5" maxlength="5" ' . ($row->is_extra ? "" : "disabled") . ' onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);" onkeypress="return blockNonNumbers(this, event, false, false);" />&nbsp;';
                                }
                                if ($lists['t_type']) {
                                    echo JText::_("W") . '<input class="form-control score" type="checkbox" id="spenwin_2" ' . (( $row->p_winner && $row->p_winner == $row->team2_id) ? "checked" : "") . ' onchange="sqchng(\'spenwin_2\',\'spenwin_1\');" name="penwin[]" value="' . $row->team2_id . '" onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);" onkeypress="return blockNonNumbers(this, event, false, false);" />';
                                }
                                ?>
                            </div>
                        </div>
                        <?php if (!$lists['t_type']) { ?>
                            <div class="form-group">
                                <label for="inputName" class="col-xs-12 col-sm-2 control-label"><?php echo JText::_('BL_TBL_POINTS'); ?> </label>
                                <div class="col-sm-10">                             
                                    <label class=""><?php echo $lists['teams1'] ?></label>
                                    <input type="text" class="form-control score" name="points1" value="<?php echo floatval($row->points1); ?>" <?php echo (!$row->new_points ? "readonly='readonly'" : "") ?> />
                                    <span>:</span>
                                    <input type="text" class="form-control score" name="points2" value="<?php echo floatval($row->points2); ?>" <?php echo (!$row->new_points ? "readonly='readonly'" : "") ?> />
                                    <label class=""><?php echo $lists['teams2'] ?></label>
                            ...
                            <div class="form-group">
                                <label for="inputName" class="col-xs-12 col-sm-2 control-label"><?php echo JText::_('BLFA_BONUS'); ?></label>
                                <div class="col-sm-10">
                                    <label class=""><?php echo $lists['teams1'] ?></label>
                                    <input type="text" class="form-control score" name="bonus1" value="<?php echo floatval($row->bonus1) ?>" />
                                    <span>:</span>
                                    <input type="text" class="form-control score" name="bonus2" value="<?php echo floatval($row->bonus2) ?>" >
                                    <label class=""><?php echo $lists['teams2'] ?></label>
                                </div>
                            </div>
                        <?php } ?>
                        <?php if ($lists['s_enbl_extra'] == 1) { ?>
                            <div class="form-group">
                                <label for="inputName" class="col-xs-12 col-sm-2 control-label"><?php echo JText::_('BLFA_ET'); ?></label>
                                <div class="col-sm-10">
                                    <input type="radio" name="is_extra" id="optionsRadios1" value="0" <?php echo!$row->is_extra ? 'checked="checked"' : '' ?>/>
                                    <?php echo JText::_('JNO'); ?>
                                    <input type="radio" name="is_extra" id="optionsRadios1" value="1" <?php echo $row->is_extra ? 'checked="checked"' : '' ?>/>
                                    <?php echo JText::_('JYES'); ?> 
                                </div>
                            </div>
                        <?php } ?>
                        <?php if ($this->acl != 1 && $lists['jsmr_mark_played'] == 1) { ?>
                            <div class="form-group">
                                <label for="inputName" class="col-xs-12 col-sm-2 control-label"><?php echo JText::_('BLFA_PLAYED'); ?></label>
                                <div class="col-sm-10">
                                    <input type="radio" name="m_played" id="optionsRadios1" value="0" <?php echo!$row->m_played ? 'checked="checked"' : '' ?>/>
                                    <?php echo JText::_('JNO'); ?>
                                    <input type="radio" name="m_played" id="optionsRadios1" value="1" <?php echo $row->m_played ? 'checked="checked"' : '' ?>/>
                                    <?php echo JText::_('JYES'); ?> 
                                </div>
                            </div>
                        <?php } ?>
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-3">
                                <input type="date" class="form-control date" id="date" name="m_date" value="<?php echo $row->m_date ? $row->m_date : date("Y-m-d"); ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputName" class="col-xs-12 col-sm-2 control-label"><?php echo JText::_('BLFA_TIME'); ?></label>
                            <div class="col-xs-12 col-sm-3">
                                <input type="text" class="form-control time" id="inputTime" name="m_time" value="<?php echo substr($row->m_time, 0, 5); ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputName" class="col-xs-12 col-sm-2 control-label"><?php echo JText::_('BLFA_LOCATION'); ?></label>
                            <div class="col-xs-12 col-sm-3">                                
                                <input type="text" class="form-control" name="m_location" value="<?php echo htmlspecialchars($row->m_location); ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        for ($p = 0; $p < count($lists['ext_fields']); $p++) {
                            if ($lists['ext_fields'][$p]->field_type == '3' && !isset($lists['ext_fields'][$p]->selvals)) {
                                ...
                                ?>
                                <div class="form-group">
                                    <label for="" class="col-xs-12 col-sm-2 control-label"><?php echo $lists['ext_fields'][$p]->name; ?></label>
                                    <div class="col-xs-12 col-sm-3">
                                        <td>
                                            <?php
                                            switch ($lists['ext_fields'][$p]->field_type) {
                                                ...
                                                case '1': echo $lists['ext_fields'][$p]->selvals;
                                                    break;
                                                case '2': echo '<textarea name="extraf[' . $lists['ext_fields'][$p]->id . ']" class="form-control" rows="6">' . htmlspecialchars(isset($lists['ext_fields'][$p]->fvalue_text) ? ($lists['ext_fields'][$p]->fvalue_text) : "", ENT_QUOTES) . '</textarea>';
                                                    break;
                                                case '3': echo $lists['ext_fields'][$p]->selvals;
                                                    break;
                                                case '0':
                                                default: echo '<input type="text" maxlength="255" size="60" class="form-control" name="extraf[' . $lists['ext_fields'][$p]->id . ']" value="' . (isset($lists['ext_fields'][$p]->fvalue) ? htmlspecialchars($lists['ext_fields'][$p]->fvalue) : "") . '" />';
                                                    break;
                                            }
                                            ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <textarea class="form-control" id="inputMatch" name="match_descr" rows="6"><?php echo htmlspecialchars($row->match_descr, ENT_QUOTES); ?></textarea>
                            </div>
                        </div>    
                                    ...
                                    if (count($lists['m_events'])) {
                                        foreach ($lists['m_events'] as $m_events) {
                                            ...
                                            if ($this->acl == 1 || (($this->lists["jsmr_edit_playerevent_opposite"] == 1 && $moder_or_pl) || ($this->lists["jsmr_edit_playerevent_yours"] == 1 && $moder_or_pl2))) {
                                                echo '<td><input type="hidden" name="em_id[]" value="' . $m_events->id . '" /><button type="button" class="close" onclick="Delete_tbl_row(this); return false;" ><span aria-hidden="true">&times;</span><span class="sr-only">' . JText::_('BLFA_DELETE') . '</span></button></td>';
                                                ...
                                                echo '<td><input class="form-control score" type="text" size="5" maxlenght="5" name="e_minuteval[]" value="' . $m_events->minutes . '" onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);" onkeypress="return blockNonNumbers(this, event, false, false);"  /></td>';
                                                echo '<td><input class="form-control score" type="text" size="5" maxlength="5" name="e_countval[]" value="' . $m_events->ecount . '" onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);" onkeypress="return blockNonNumbers(this, event, false, false);" /></td>';
                        ...
                        if (!$lists['jsmr_edit_playerevent_yours'] && !$lists['jsmr_edit_playerevent_opposite'] && ($this->acl == 2 || $this->acl == 3)) {
                            ...
                            <div class="table-responsive col-xs-12 col-lg-12">
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th colspan="7" class="text-center"><?php echo JText::_('BLFA_ADDPLEVENTS'); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control score" name="e_minutes" id="e_minutes"></td>
                                            <td><input type="text" class="form-control score" name="re_count" id="re_count">
                                                <button type="button" class="btn btn-default add" onclick="bl_add_event();" ><?php echo JText::_('BLFA_ADD'); ?></button></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <?php if (!$lists['t_single']) { ?>
                            <div class="table-responsive col-xs-12 col-lg-12">
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th colspan="7" class="text-center"><?php echo JText::_('BLFA_MATCHSTATS'); ?></th>
                                        </tr>
                                        <tr>
                                            <th>#</th>
                                            <th><?php echo JText::_('BLFA_MATCHSTATSEV'); ?></th>
                                            <th><?php echo JText::_('BLFA_TT_TEAM'); ?></th>
                                            <th>&nbsp;</th>
                                            <th><?php echo JText::_('BLFA_COUNT'); ?></th>
                                            <th>&nbsp;</th>
                                            <th>&nbsp;</th>
                                        ...
                                        if (count($lists['t_events'])) {
                                            foreach ($lists['t_events'] as $m_events) {
                                                ...
                                                if ($this->acl != 1 && (($this->lists["jsmr_edit_matchevent_opposite"] == 0 && !in_array($m_events->pid, $this->lists["teams_season"])) || ($this->lists["jsmr_edit_matchevent_yours"] == 0 && in_array($m_events->pid, $this->lists["teams_season"])))) {
                                                    ...
                                                    echo '<td><input type="hidden" name="et_id[]" value="' . $m_events->id . '" /><button type="button"  onclick="Delete_tbl_row(this); class="close"><span aria-hidden="true">&times;</span><span class="sr-only">' . JText::_('BLFA_DELETE') . '</span></button>';
                                                    ...
                                                    echo '<td></td>';
                                                    echo '<td><input class="form-control score" type="text" size="5" maxlenght="5" name="et_countval[]" value="' . $m_events->ecount . '" onblur="extractNumber(this,0,false);" onkeyup="extractNumber(this,0,false);" onkeypress="return blockNonNumbers(this, event, false, false);" /></td>';
                                                    echo '<td>';
                                                    echo '</td>';
                                                    echo '<td>';
                                                    echo '</td>';
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input name="e_count" id="et_count" type="text" class="form-control score" />
                                                    <button onclick="bl_add_tevent();"  type="button" class="btn btn-default add"><?php echo JText::_('BLFA_ADD'); ?></button></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                        ...
                        <div class="upload col-xs-12 col-lg-12">
                            <div class="form-group">
                                <label for="input" class="col-xs-12 col-sm-12 control-label"><?php echo JText::_('BLFA_UPLPHTOMTCH'); ?></label>
                                <div class="col-xs-12">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($lists['photos'] as $photos) {
                                            if (is_file(JPATH_ROOT . '/media/bearleague/' . $photos->filename)) {
                                                ...
                                                <tr>
                                                    <td class="">
                                                        <button type="button" class="close" title="<?php echo JText::_('BLFA_REMOVE'); ?>" onclick="Delete_tbl_row(this);"><span aria-hidden="true">&times;</span><span class="sr-only"><?php echo JText::_('BLFA_REMOVE'); ?></span></button>
                                                        <input type="hidden" name="photos_id[]" value="<?php echo $photos->id; ?>"/>
                                                    </td>                                            
                                                    <td class="w50">                                                
                                                        <input type="text" class="form-control" maxlength="255" name="ph_names[]" value="<?php echo htmlspecialchars($photos->name) ?>" />                                                            
                                                    </td>
                                                    <td class="">                                                            
                                                        <?php
                                                        ...
                                                        ?>
                                                        <img src="<?php echo JURI::base(); ?>media/bearleague/<?php echo $photos->filename ?>" class="img-responsive w50" width="<?php echo $width; ?>" />
                                                    </td>
                                                </tr>
                                                <?php
                                            }
        ...
        if (size_img > serv_sett) {
            ...
            submitbutton('match_apply');
                ...
                <div role="tabpanel" class="tab-pane" id="squad">
                    <h5><?php echo JText::_('BLFA_LINEUP'); ?>:</h5>
                    <div class="row">
                        <div class="table-responsive col-xs-6 col-lg-6 tableRight">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th colspan="3" class="text-center"><?php echo $lists['teams1']; ?></th>
                                    </tr>
                                    <tr>
                                        <th><?php echo JText::_('BLFA_PLAYER'); ?></th>
                                        <th><?php echo JText::_('BLFA_LINEUP'); ?>:</th>
                                        <th><?php echo JText::_('BLFA_SUBSTITUTES'); ?>:</th>
                                    </tr>
                                </thead>
                        ...
                        <div class="table-responsive col-xs-6 col-lg-6 tableLeft">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th colspan="3" class="text-center"><?php echo $lists['teams2']; ?></th>
                                    </tr>
                                    <tr>
                                        <th><?php echo JText::_('BLFA_PLAYER'); ?></th>
                                        <th><?php echo JText::_('BLFA_LINEUP'); ?>:</th>
                        ...
                        <div class="table-responsive col-xs-6 col-lg-6 tableRight">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th><?php echo JText::_('BLFA_PLAYERIN'); ?></th>
                                        <th><?php echo JText::_('BLFA_PLAYEROUT'); ?></th>
                                        <th><?php echo JText::_('BLFA_MINUTES'); ?></th>
                                    </tr>
                                </thead>
                                <tbody id="subsid_1">
                                    ...
                                    if ($this->acl != 1 && (($this->lists["jsmr_edit_squad_opposite"] == 0 && !in_array($row->team1_id, $this->lists["teams_season"])) || ($this->lists["jsmr_edit_squad_yours"] == 0 && in_array($row->team1_id, $this->lists["teams_season"])))) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input class="form-control score" type="text" name="minutes1" id="minutes1" value="" maxlength="5" size="5" />
                                                <button onclick="js_add_subs('subsid_1', 'playersq1_id', 'playersq1_out_id', 'minutes1');" type="button" class="btn btn-default add"><?php echo JText::_('BLFA_ADD'); ?></button>                                            
                                            </td>
                                        </tr>
                                    <?php } ?>      
                                    <?php
                                    if (count($lists["subsin1"])) {
                                        for ($i = 0; $i < count($lists["subsin1"]); $i++) {
                                            ...
                                            if ($this->acl != 1 && (($this->lists["jsmr_edit_squad_opposite"] == 0 && !in_array($row->team1_id, $this->lists["teams_season"])) || ($this->lists["jsmr_edit_squad_yours"] == 0 && in_array($row->team1_id, $this->lists["teams_season"])))) {
                                                ...
                                                echo '<button type="button" onclick="Delete_tbl_row(this); return false;" class="close"><span aria-hidden="true">&times;</span><span class="sr-only">' . JText::_('BLFA_DELETE') . '</span></button>';
                                            }
                                            echo "</td>";
                                            echo "<td>";
                                            ...
                                            if ($this->acl != 1 && (($this->lists["jsmr_edit_squad_opposite"] == 0 && !in_array($row->team1_id, $this->lists["teams_season"])) || ($this->lists["jsmr_edit_squad_yours"] == 0 && in_array($row->team1_id, $this->lists["teams_season"])))) {
                                                ...
                                                echo '<input class="form-control score" type="text" value="' . $subs->minutes . '" name="minutes1_arr[]" maxlength="5" size="5" />';
                                            }
                                            echo "</td>";
                                            echo "</tr>";
                                        }
                                ...
                                <tbody id="subsid_2">
                                    ...
                                    if ($this->acl != 1 && (($this->lists["jsmr_edit_squad_opposite"] == 0 && !in_array($row->team2_id, $this->lists["teams_season"])) || ($this->lists["jsmr_edit_squad_yours"] == 0 && in_array($row->team2_id, $this->lists["teams_season"])))) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input class="form-control score" type="text" name="minutes2" id="minutes2"  value="" maxlength="5" size="5" />
                                                <button onclick="js_add_subs('subsid_2', 'playersq2_id', 'playersq2_out_id', 'minutes2');"  type="button" class="btn btn-default add"><?php echo JText::_('BLFA_ADD'); ?></button>                                            
                                            </td>
                                        </tr>
                                        <?php
                                    }
                                    if (count($lists["subsin2"])) {
                                        for ($i = 0; $i < count($lists["subsin2"]); $i++) {
                                            ...
                                            if ($this->acl != 1 && (($this->lists["jsmr_edit_squad_opposite"] == 0 && !in_array($row->team2_id, $this->lists["teams_season"])) || ($this->lists["jsmr_edit_squad_yours"] == 0 && in_array($row->team2_id, $this->lists["teams_season"])))) {
                                                ...
                                                echo '<input class="form-control score" type="text" value="' . $subs->minutes . '" name="minutes2_arr[]" maxlength="5" size="5" />';
                                            }
                                            echo "</td>";
                                            echo "</tr>";
                                        }
