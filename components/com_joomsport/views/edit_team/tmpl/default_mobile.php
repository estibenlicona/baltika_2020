...
<?php endif; ?>
    ...
    function addplayer() {
        ...
        cell1.innerHTML = '<button onclick="javascript:Delete_tbl_row(this); return false;" title="<?php echo JText::_('BLFA_DELETE'); ?>" type="button" class="close"><span aria-hidden="true">&times;</span><span class="sr-only"><?php echo JText::_('BLFA_DELETE'); ?></span></button>';
...
<div class="page-content">
    ...
    <div class="main editTeam">
        <div class="heading col-xs-12 col-lg-12">
            <h1 class="pull-left col-xs-12 col-sm-12 col-md-4 col-lg-4"><?php echo $row->id ? JText::_('BLFA_TEAM_EDIT') : JText::_('BLFA_NTEAM'); ?></h1>
            ...
            <?php if ($this->lists['waiting_players_count']) { ?>
                <h6 class="pull-left col-xs-12 col-sm-12 col-md-4 col-lg-4"><?php echo JText::_('BLFA_APPROVE') . ":"; ?>:</h6>
                <?php for ($i = 0; $i < count($this->lists['waiting_players_count']); $i++) { ?>
                    <a href="<?php echo JURI::base(); ?>index.php?option=com_joomsport&task=team_edit&controller=moder&tid=<?php echo $row->id; ?>&moderseason=<?php echo $this->lists['waiting_players_count'][$i]->s_id; ?>&jscurtab=etab_pl" class="pull-left col-xs-12 col-sm-12 col-md-4 col-lg-4" href="#"><?php echo $this->lists['waiting_players_count'][$i]->s_name . " (" . $this->lists['waiting_players_count'][$i]->kol . ")"; ?></a><br/>
                <?php } ?>
            <?php } ?>
        </div>
        <div class="navbar-link col-xs-12 col-lg-12">
            <?php if ($this->acl != 1) { ?>
                <ul>
                    <li class="active"><a href="<?php echo JRoute::_('index.php?option=com_joomsport&controller=moder&view=edit_team&tid=' . $row->id . "&Itemid=" . $Itemid); ?>"><?php echo JText::_('BLFA_TEAM') ?></a></li>
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="#team" role="tab" data-toggle="tab"><i class="star"></i><?php echo JText::_('BLFA_TEAM'); ?></a></li>
                ...
                <div role="tabpanel" class="tab-pane active" id="team">
                    <div class="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" maxlength="255" name="t_name" id="t_name" value="<?php echo htmlspecialchars($row->t_name) ?>" />                                
                            </div>
                        </div>
                        <?php if ($fCity['enabled']): ?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" maxlength="255" class="form-control" id="t_city" name="t_city" value="<?php echo htmlspecialchars($row->t_city) ?>" />                                
                                </div>
                            </div>
                        <?php endif; ?>
                        <?php
                        for ($p = 0; $p < count($lists['ext_fields']); $p++) {
                            if ($lists['ext_fields'][$p]->field_type == '3' && !isset($lists['ext_fields'][$p]->selvals)) {
                                ...
                                if ($lists['s_id'] > 0 && $lists['ext_fields'][$p]->season_related) {
                                    ?>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label"><?php echo $lists['ext_fields'][$p]->name; ?></label>
                                        <div class="col-sm-4">
                                            <?php
                                            switch ($lists['ext_fields'][$p]->field_type) {
                                                ...
                                                case '3': echo $lists['ext_fields'][$p]->selvals;
                                                    break;
                                                case '0':
                                                default: echo '<input type="text" class="form-control' . ($lists['ext_fields'][$p]->reg_require ? ' required' : '') . '" maxlength="255" name="extraf[' . $lists['ext_fields'][$p]->id . ']" value="' . (isset($lists['ext_fields'][$p]->fvalue) ? htmlspecialchars($lists['ext_fields'][$p]->fvalue) : "") . '" />';
                                                    break;
                                            }
                                            ?>
                                ...
                                <?php } else if (!$lists['ext_fields'][$p]->season_related && $lists['ext_fields'][$p]->reg_exist) { ?>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label"><?php echo $lists['ext_fields'][$p]->name; ?></label>
                                        <div class="col-sm-4">
                                            <?php
                        ...
                        <?php if ($row->t_emblem && is_file('media/bearleague/' . $row->t_emblem)) { ?>
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-5">   
                                    ...
                                    <button type="button" onclick="javascript:delete_logo();" class="close"><span aria-hidden="true">&times;</span><span class="sr-only"><?php echo JText::_('BLFA_REMOVE'); ?></span></button>
                                </div>
                            </div>                  
                        <?php } ?>                        
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control" name="t_descr" id="t_descr" rows="6"><?php echo htmlspecialchars($row->t_descr, ENT_QUOTES); ?></textarea>
                            </div>
                        </div>            
                        <div class="upload col-xs-12 col-lg-12">
                            <div class="form-group">
                                <label class="col-xs-12 col-sm-12 control-label"><?php echo JText::_('BLFA_UPLFOTO'); ?> <i class="fa fa-question-circle"></i></label>
                                <div class="col-xs-12">
    ...
    but_on.onclick = function() {
        ...
        if (size_img > serv_sett) {
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($lists['photos'] as $photos) {
                                                if (is_file(JPATH_ROOT . '/media/bearleague/' . $photos->filename)) {
                                                    ...
                                                    <tr>
                                                        <td class="">
                                                            <button type="button" class="close" title="<?php echo JText::_('BLFA_REMOVE'); ?>" onclick="javascript:Delete_tbl_row(this);"><span aria-hidden="true">&times;</span><span class="sr-only"><?php echo JText::_('BLFA_REMOVE'); ?></span></button>
                                                        </td>
                                                        <td class="">
                                                            <?php
                                    ...
                                    <tbody id="add_pl">
                                        ...
                                        for ($i = 0; $i < count($lists['team_players']); $i++) {
                                            ...
                                            <tr class="<?php echo ($i % 2 ? "" : "active") ?>">
                                                <td class="">
                                                    <button type="button" class="close" onclick="javascript:Delete_tbl_row(this);
            ...
            return false;"><?php echo JText::_('BLFA_ADD'); ?></button>
                                </div>
                            </div>
                ...
                return false;">
                                ...
                                <?php if ($lists['esport_invite_unregister']) { ?>			
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12"> <span><?php echo JText::_("BLFA_INVITEUNREG"); ?></span> </div>
                                    </div>
                                    <table class="table table-striped">
                                        <tbody id="initetbl">
                                            <tr>
                                                <td colspan="2">
                                                    <input type="text" id="invemail" name="invemail" value="" size="100" class="form-control" />
                                                    <button class="btn send-button" onclick="inviteemail();
                    return false;" ><span><?php echo JText::_('BLFA_INVITE'); ?></span></button>
                                                </td>
                                            </tr>
                                        </tbody>	
                                    </table>
                                ...
                                <?php if ($lists['esport_join_team'] && count($lists["waiting_players"])) { ?>
                                    <div class="form-group">
                                        <div class="col-sm-12"> <span><?php echo JText::_("BLFA_WAITINGAPPROVAL"); ?></span> </div>
                                    </div>
                                    <?php for ($z = 0; $z < count($lists["waiting_players"]); $z++) { ?>
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-lg-12">
                                                <?php echo JHTML::_('select.genericlist', $lists["arr_action"], 'action_' . $lists["waiting_players"][$z]->id, 'class="form-control" size="1"', 'id', 'name', 0); ?>
                                            </div>
                                        </div>
                                    <?php } ?>				
                                <?php } ?>
