...
<?php
		...
		<table class="jsnoborders">
			<tr>
				<td width="100">
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'BLFA_FIRSTNAME' ); ?>::<?php echo JText::_( 'BLFA_TT_FIRST_NAME' );?>"><img src="administrator/components/com_bearleague/img/quest.jpg" border="0" /></span>
				</td>
				<td>
			...
			<tr>
				<td width="100">
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'BLFA_LASTNAME' ); ?>::<?php echo JText::_( 'BLFA_TT_LAST_NAME' );?>"><img src="administrator/components/com_bearleague/img/quest.jpg" border="0" /></span>
				</td>
				<td>
			...
			<tr>
				...
				<td>
					<input type="text" maxlength="255" size="60" name="extraf[<?php echo $lists['ext_fields'][$p]->id?>]" value="<?php echo isset($lists['ext_fields'][$p]->fvalue)?htmlspecialchars($lists['ext_fields'][$p]->fvalue):""?>" />
			...
			<tr>
				<td width="100">
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'BLFA_TEAM' ); ?>::<?php echo JText::_( 'BLFA_TT_TEAM' );?>"><img src="administrator/components/com_bearleague/img/quest.jpg" border="0" /></span>
				</td>
				<td>
			...
			<tr>
				<td width="100">
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'BLFA_ABOUT_PLAYER' ); ?>::<?php echo JText::_( 'BLFA_TT_ABOUT_PLAYER' );?>"><img src="administrator/components/com_bearleague/img/quest.jpg" border="0" /></span>
				</td>
				<td>
					<?php  echo $this->editor->display( 'about',  htmlspecialchars($row->about, ENT_QUOTES), '550', '300', '60', '20', false ) ;  ?>
		...
		<table style="padding:10px;" class="jsnoborders">
			<tr>
				<td>
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_('BLFA_UPLFOTO');?>::<?php echo JText::_( 'BLFA_TT_UPLOAD_PL_PHOTO' );?>"><img src="administrator/components/com_bearleague/img/quest.jpg" border="0" /></span>
				</td>
			</tr>
			<tr>
				<td>&nbsp;
			...
			<tr>
				<td>
					<input type="button" value="<?php echo JText::_('BLFA_UPLOAD')?>" onclick="javascript:submitbutton('player_apply');" />
				</td>
			</tr>
		</table>
		<?php
		...
		<table class="adminlist">
			...
			<td align="center">
				<?php
				$imgsize = getimagesize('media/esport/'.$photos->filename);
				if($imgsize[0] > 200){
					$width = 200;
				}else{
					$width  = $imgsize[0];
				...
				?>
				<a rel="{handler: 'image'}" href="<?php echo JURI::base();?>media/esport/<?php echo $photos->filename?>" title="Image" class="modal-button"><img src="<?php echo JURI::base();?>media/bearleague/<?php echo $photos->filename?>" width="<?php echo $width;?>" /></a>
			</td>
			</tr>
			<?php
			}
