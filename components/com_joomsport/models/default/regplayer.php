...
class regplayerJSModel extends JSPRO_Models
{
	...
	function getCountries(){
		...
		$this->_lists["country"] = JHTML::_('select.genericlist',   $countries, 'country_id', 'class="'.(js_mobile::isMobile()?'form-control':'styled-long').' '.($this->_lists['country_reg_rq']?" required":"").'" size="1"', 'id', 'country', isset($this->_lists["usr"]->country_id)?$this->_lists["usr"]->country_id:0 );
	}
	function getJSreg(){
