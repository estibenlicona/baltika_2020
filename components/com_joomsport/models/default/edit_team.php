...
////////UPDATE
	...
	function getPlayersT($id,$s_id){
		...
		$this->_lists['player'] = JHTML::_('select.genericlist',   $playerz, 'playerz_id', 'class="'.(js_mobile::isMobile()?'form-control':'styled').'" size="1" id="playerz"', 'id', 'name', 0 );
		if($this->acl == 1){
