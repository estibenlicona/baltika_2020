...
function MySpaceGetThis(U)
{
	...
	echo '<div class="pfbcm">'."\n"
        ...
        .'<img src="http://cms.myspacecdn.com/cms//ShareOnMySpace/Myspace_btn_Share.png" style="border:none;" alt="'
...
if ((int)$tmpl['fb_like_enable'] == 1){
    ...
    echo '<div class="pfbcl">'."\n"
         .'<iframe src="http://www.facebook.com/plugins/like.php?app_id=133499630061802&amp;href='.$tmpl['uri'].'&amp;send=false&amp;layout=standard&amp;width='.(int)$tmpl['fb_like_width'].'&amp;show_faces='.$tmpl['fb_like_show_faces'].'&amp;action=like&amp;'.$colorSchemeL.'&amp;font&amp;height='.(int)$tmpl['fb_like_height'].'"  style="border:none; overflow:hidden; width:'.(int)$tmpl['fb_like_width'].'px; height:'.(int)$tmpl['fb_like_height'].'px;" ></iframe>'
         .'</div>'."\n";
}
