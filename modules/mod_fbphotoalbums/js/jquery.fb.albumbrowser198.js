    ...
    $.fn.FacebookAlbumBrowser = function (options) {
        ...
        selector.each(function (index) {
                            ...
                            for (a = 0; a < $(result.data).length; a++) {
                                ...
                                if ($(result.data).get(a).count == null && settings.skipEmptyAlbums) {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (cover) {
                                            ...
                                            if (!$(cover).get(0).error && $(cover).get(0).images) {
                                                ...
                                                var albumThumb = $("<img>", { style: "margin-left:0; height:100%; display:none;", "data-id": $(cover).get(0).id, class: "fb-album-thumb", "data-src": albumImg.source, src: "" })
                                    ...
                                    $(albumListItem).click(function () {
                                        ...
                                        $(previewContainer).append($("<ul>", { class: "fb-photos", "style": "min-height:" + settings.thumbnailSize + " !important" }));
                    ...
                    success: function (result) {
                        if (result.data.length > 0) {
                            ...
                            for (a = 0; a < result.data.length; a++) {
                                ...
                                var photoThumb = $("<img>", { style: "margin-left:0;height:100%;display:block;", "data-id": $(result.data).get(a).id, class: "fb-photo-thumb", "data-src": albumImg.source, src: "" });
            ...
            function initLightboxes(photoLink) {
                ...
                if (overlay.length == 0) {
					//$(previewContainer).append($("<ul>", { class: "fb-photos", "style": "min-height:" + settings.thumbnailSize + " !important" }))
                    overlay = $("<div>", { class: "fb-preview-overlay", "style": "background-color:" +settings.lightboxOverlay + " !important" });
